...
public abstract class ParallelExecutor {
    ...
    public static <T1, T2> Tuple2<T1, T2> with(Supplier<T1> task1, Supplier<T2> task2, Executor executor) {
        ...
        CompletableFuture<T1> f1 = CompletableFuture.supplyAsync(
                task1,
                executor
        );
        CompletableFuture<T2> f2 = CompletableFuture.supplyAsync(
                task2,
                executor
        );
        return new Tuple2<>(
    ...
    public static <T1, T2, T3> Tuple3<T1, T2, T3> with(Supplier<T1> t1, Supplier<T2> t2, Supplier<T3> t3, Executor ex) {
        ...
        CompletableFuture<T3> f3 = CompletableFuture.supplyAsync(
                t3,
                ex
        );
        return new Tuple3<>(
    ...
    public static <T1, T2, T3, T4> Tuple4<T1, T2, T3, T4> with(
        ...
        CompletableFuture<T4> f4 = CompletableFuture.supplyAsync(
                t4,
                ex
        );
        return new Tuple4<>(
    ...
    public static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> with(
        ...
        CompletableFuture<T5> f5 = CompletableFuture.supplyAsync(
                t5,
                ex
        );
        return new Tuple5<>(
